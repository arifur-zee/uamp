...
interface MusicSource : Iterable<MediaMetadataCompat> {
    ...
    fun search(query: String, playWhenReady: Boolean, extras: Bundle)

    fun search(query: String, playWhenReady: Boolean, extras: Bundle, onResult: (List<MediaMetadataCompat>) -> Unit)
